...
class laptopSamsungGalaxyBook4SeriesFullDetailsUserDashboard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_laptop_samsung_galaxy_book4_series_full_details_user_dashboard)
