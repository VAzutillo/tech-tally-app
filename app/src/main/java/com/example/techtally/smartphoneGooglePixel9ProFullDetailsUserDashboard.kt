...
class smartphoneGooglePixel9ProFullDetailsUserDashboard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_smartphone_google_pixel9_pro_full_details_user_dashboard)
