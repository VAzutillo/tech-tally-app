...
class SamsungGalaxyS24UltraFullDetailsSmartphoneCategory : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_samsung_galaxy_s24_ultra_full_details_smartphone_category)
