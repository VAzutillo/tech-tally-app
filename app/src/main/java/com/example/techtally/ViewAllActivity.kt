...
class ViewAllActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        smartphoneInfinixNote40ProPlusFullDetails.setOnClickListener {
            val intent = Intent(this, smartphoneInfinixNote40ProPlusFullDetails::class.java)
            startActivity(intent)
        }
        ...
        tabletLenovoChromebookDuet11FullDetails.setOnClickListener {
            val intent = Intent(this, tabletLenovoChromebookDuet11FullDetails::class.java)
            startActivity(intent)
        }
        ...
        laptopLenovoLegion7IPlusFullDetails.setOnClickListener {
            val intent = Intent(this, laptopLenovoLegion7IPlusFullDetails::class.java)
            startActivity(intent)
        }
        ...
        tabletOppoPad2FullDetails.setOnClickListener {
            val intent = Intent(this, tabletOppoPad2FullDetails::class.java)
            startActivity(intent)
        }
        ...
        smartphoneRealme13ProPlusFullDetails.setOnClickListener {
            val intent = Intent(this, smartphoneRealme13ProPlusFullDetails::class.java)
            startActivity(intent)
        }
        ...
        tabletRealmePad2FullDetails.setOnClickListener {
            val intent = Intent(this, tabletRealmePad2FullDetails::class.java)
            startActivity(intent)
        }
        ...
        laptopGalaxyBook4SeriesFullDetails.setOnClickListener {
            val intent = Intent(this, laptopGalaxyBook4SeriesFullDetails::class.java)
            startActivity(intent)
        }
        ...
        smartphoneVivoX100ProFullDetails.setOnClickListener {
            val intent = Intent(this, smartphoneVivoX100ProFullDetails::class.java)
            startActivity(intent)
        }
        ...
        smartphoneXiaomi14UltraFullDetails.setOnClickListener {
            val intent = Intent(this, smartphoneXiaomi14UltraFullDetails::class.java)
            startActivity(intent)
        }
        ...
        laptopXiaomiNotebookProFullDetails.setOnClickListener {
            val intent = Intent(this, laptopXiaomiNotebookProFullDetails::class.java)
            startActivity(intent)
        }
        ...
        tabletXiaomiPad6ProFullDetails.setOnClickListener {
            val intent = Intent(this, tabletXiaomiPad6ProFullDetails::class.java)
            startActivity(intent)
        }
    }
