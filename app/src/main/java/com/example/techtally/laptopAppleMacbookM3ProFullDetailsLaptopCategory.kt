...
class laptopAppleMacbookM3ProFullDetailsLaptopCategory : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_laptop_apple_macbook_m3_pro_full_details_laptop_category)
        ...
        val backToUserDashboardActivity = findViewById<ImageView>(R.id.laptopAppleMacbookM3ProFullDetailsBackButton)
