...
class laptopXiaomiNotebookPro120gFullDetailsUserDashboard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_laptop_xiaomi_notebook_pro120g_full_details_user_dashboard)
