...
class smartphoneGooglePixel9ProFullDetailsViewAll : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_smartphone_google_pixel9_pro_full_details_view_all)
